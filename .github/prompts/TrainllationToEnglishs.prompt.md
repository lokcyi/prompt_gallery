...
搜尋專案目錄 prompt-gallery 中的所有子目錄，找到所有 .md (Markdown) 檔案，並將其中的韓文內容翻譯為繁體中文，最後將翻譯後的內容儲存回原檔案。請確保保留 Markdown 格式，並且只翻譯韓文部分，不影響其他內容。如果檔案名稱有韓文 ,將其重新命名為英文名稱。
 ignore the folder  "Blog-Article_Creation,Coaching,Design,Image_Generation,Investigation,Job Search-Career Change2,Marketing,Planning and_Idea_Generation,Prompts"目錄
先搜尋 目錄 "Side Hustle"
